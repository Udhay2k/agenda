 ...
 */
module.exports = async function (interval, names, data, startDate, endDate, type, options) {
  /**
   ...
   */
  const createJob = async (interval, names, data, startDate, endDate, type, options) => {
    const job = this.create(names, data, startDate, endDate, type, options);
   ...
   */
  const createJobs = (interval, names, data, startDate, endDate, type, options) => {
    try {
